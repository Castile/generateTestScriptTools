...
//        Configuration configuration = new Configuration(Configuration.VERSION_2_3_23);
//
////        URL resource = MyTestCasesGenerator.class.getClassLoader().getResource("./");
////        String file = resource.getFile();
////        System.out.println(file);
//        //文件路径加载器
//        FileTemplateLoader ftl = new FileTemplateLoader(new File("template"));
//
...
//    }
    ...
    protected Writer getWriter(CasesData casesData) throws Exception {
        ...
        bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(testScripts), "utf-8"));
